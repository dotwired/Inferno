<?php
 ...
 if(!class_exists( 'Inferno_Widget_Video' ) ) {
    class Inferno_Widget_Video extends Inferno_Widget
    {
        public $widget = array(
            'title'       => 'Inferno Video',
        ...
        public function __construct() {
            parent::register_widget(
                'inferno-video', // Base ID
                $this->widget['title'], // Name
                array('classname' => 'inferno-video', 'description' => $this->widget['description'])
            );
        }
        ...
        public function widget($args, $instance) {
            ...
            echo '<div class="inferno-widget-video">';

            if(!empty($description))
                echo '<p>' . $description . '</p>';

            echo '<div class="inferno-elastic-video">' . $video . '</div>';
            echo '</div>';
            echo $after_widget;
        }
    ...
    add_action('widgets_init', create_function('', 'return register_widget("Inferno_Widget_Video");'));
}
